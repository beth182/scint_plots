...
# plot
series_labels = ['broadleaf tree', 'needleleaf tree', 'Grass', 'C4 grass', 'Shrub', 'lake', 'Soil', 'ice', 'Impervious',
                 'Building']
colors = ['teal', 'darkgreen', 'lawngreen', 'coral', 'olive', 'deepskyblue', 'sienna', 'lightsteelblue', 'silver',
          'dimgrey']
...
for i, row_data in enumerate(data):
    ...
    if row_data < 0.0000001:
        leg_label = None
    else:
        leg_label = series_labels[i]
