...
# ToDo: fill in the 0 vals (stand in for unkown vals) once the csv files have been created
model_level_heights = {'BCT_IMU': {1: 89, 0: 63, -1: 0},
                       'IMU_BTT': {1: 0, 0: 103, -1: 77},
                       'BTT_BCT': {1: 0, 0: 103, -1: 77},
                       'SCT_SWT': {1: 0, 0: 36, -1: 16}
                       }
