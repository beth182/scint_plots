...
def scatter_paths_wind_direction(df_combine, save_path):
    """
...
if __name__ == "__main__":
    ...
    # df_combine = read_obs_csvs.read_all_of_preprocessed_scint_csv()
    # scatter_paths(df_combine, save_path)

    df_combine = read_obs_csvs.read_all_of_preprocessed_scint_csv(['QH', 'wind_direction_corrected'])
